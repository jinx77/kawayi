window.app = {
	 ...
	 * netty服务后端发布的url地址
	 */
	nettyServerUrl: 'ws://192.168.1.104:8088/ws',
	//nettyServerUrl: 'ws://iw8eh9.natappfree.cc/ws',
	
	/**
	 * 后端服务发布的url地址
	 */
	//serverUrl: 'http://5ee386f7.ngrok.io/',
	serverUrl: 'http://192.168.1.104:8080//',
	
	/**
	 * 图片服务器的url地址
	 */
	//imgServerUrl: 'http://192.168.44.143:88/kawayi/',
	imgServerUrl: 'http://zxq.mynatapp.cc/kawayi/',
	 ...
	 * 保存群信息
	 */
	setGroupchatList: function(groupchatList){
		
		if(groupchatList.length>0){
		plus.storage.setItem("groupchatList",JSON.stringify(groupchatList));
			}
			else{
				
				plus.storage.removeItem("groupchatList");
			}
	},
	...
	getGroupchatList: function(){
		var foo = plus.storage.getItem("groupchatList");
		if(foo==null){
			return null;
		}
